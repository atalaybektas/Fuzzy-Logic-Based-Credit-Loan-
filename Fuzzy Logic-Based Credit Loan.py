...
# "and" rule is minimum fonction 
# "or" rule is maximum function
...
# ## Example Output For Rule Base 1 house evaluation
""""
## triying the function with example
h_eval = apply_house_rules(250, 4, verbose=0)
"""
...
## triying the function with example
""""
a_eval = apply_applicant_rules(550, 45, verbose=0)
"""
...
def make_decision(market_value, location, assets, income, interest, verbose=0):
    ...
    print ("Output Credit: ", defuzz_credit, "x10^3 $")
